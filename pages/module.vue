                            ...
                            <v-card>
                                ...
                                <v-card-text>
                                    <v-container>
                                        <v-row>
                                            <v-col cols="12" md="4">
                                                <v-text-field label="Id del modulo" v-model="moduleId"
                                            ...
                                            <v-col cols="12" md="4">
                                                <v-text-field label="Nombre del modulo" v-model="moduleName"
                                                    required></v-text-field>
                                            </v-col>
                                        </v-row>
                                    </v-container>
...
export default {
    ...
    methods: {
        ...
        async deleteItemConfirm() {
            await deleteDoc(doc(db, "level", this.module.id));
            this.closeDelete();
        },
        ...
        async save() {
            if (this.saveMode) {
                await setDoc(doc(db, "module", this.moduleId), {
                    level: this.moduleLevel,
                    id: this.moduleId,
                    name: this.moduleName
                });
            } else {
                const docRef = doc(db, "module", this.moduleId);
