...
var studentsvue_type_template_id_35e0cb40_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
// CONCATENATED MODULE: ./pages/students.vue?vue&type=template&id=35e0cb40&
...
/* harmony default export */ var studentsvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    async deleteItemConfirm() {
      await Object(firestore_["deleteDoc"])(Object(firestore_["doc"])(firebase["c" /* db */], "students", this.studentsId.dni));
      this.closeDelete();
    },
    close() {
      this.dialog = false;
    ...
    editItem(item) {
      if (item.currentCourse != this.currentCourse) this.changeRevisor = true;
      this.dialog = true;
      this.name = item.name;
    ...
    async save() {
      const docRef = Object(firestore_["doc"])(firebase["c" /* db */], "students", this.dni);
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  studentsvue_type_template_id_35e0cb40_render,
  staticRenderFns,
  false,
  null,
  null,
